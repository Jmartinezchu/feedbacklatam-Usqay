                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h3 class="font-weight-bolder" :class="{ 'text-danger': cards.valorNPS < 0 }">
                                    {{ cards.valorNPS }}%
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h3 class="font-weight-bolder">
                                    {{ cards.allEncuestadosCompanie }} <v-icon>group</v-icon>
                                </h3>
                            </div>
                        </div>
                        <div class="col-4 text-end">
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h3 class="font-weight-bolder">
                                    {{ cards.allComentsCompanie }} <v-icon>comment</v-icon>
                                </h3>
                            </div>
                        </div>
                        <div class="col-4 text-end">
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h3 class="font-weight-bolder">
                                    {{ cards.lengthQrs }} <v-icon>qr_code</v-icon>
                                </h3>
                            </div>
                        </div>
                        <div class="col-4 text-end">
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h3 class="font-weight-bolder">
                                    {{ cards.lengthPersonal }} <v-icon>badge</v-icon>
                                </h3>
                            </div>
                        </div>
                        <div class="col-4 text-end">
            ...
            <div class="card" style="height: 100px;">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-uppercase font-weight-bold">Multilinks</p>
                                <h3 class="font-weight-bolder">
                                    {{ cards.lengthmultilink }} <v-icon>badge</v-icon>
                                </h3>
                            </div>
                        </div>
                        <div class="col-4 text-end">
...
export default {
    ...
    async mounted() {
        ...
        // if (this.dataapiCards && Object.keys(this.dataapiCards).length > 0) {
        //     this.dataCards = this.dataapiCards;
