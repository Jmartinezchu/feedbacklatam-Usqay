<template>
  <v-app>
    <CustomersHeaderPanel></CustomersHeaderPanel>
    <v-content>
      <v-container>
        <nuxt />
      </v-container>
    ...
    <v-footer :fixed="fixed" app>
      <span>&copy; {{ new Date().getFullYear() }} Feedback</span>
    </v-footer>
  </v-app>
</template>
...
export default {
  head: {
    ...
    link: [
      ...
      { rel: "stylesheet", type: "text/css", href: "/css/panel.css" },
      { rel: "stylesheet", type: "text/css", href: "/css/panel-02.css" },
      // { rel: "stylesheet", type: "text/css", href: "/css/app.styl" },
