    ...
    <div>
        ...
        <div class="d-flex justify-content-between" style="align-items:center ">
            <div class="col-9 flex">
                <nuxt-link :to="`/${user.nameCompanie}/typeCompanie/${id_type}`">
                    <div data-v-step="3"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <v-text-field v-model="form.namecategori" label="Nuevo Categoria"
                                            :rules="rules"></v-text-field>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <v-text-field v-model="form.descripcategori" label="Descripción"
                                            :rules="rules"></v-text-field>
                                    </div>
                                </div>
                            </div>
...
export default {
    ...
    data() {
        return {
            ...
            rules: [
                ...
                value => (value && value.length >= 3) || 'No espeficica',
            ],
            rol: null,
            user: [],
            sucursales: [],
    ...
    methods: {
        async addQr() {
            const params = {
                name: this.form.namecategori,
                description: this.form.descripcategori,
                id_type_companie: this.id_type
            }
            const data = await this.$axios.$post(`${Api}/types/categori`, params).catch(error => {
        ...
        getCreate(data) {
            if (this.form.namecategori != null && this.form.descripcategori != null) {
                ...
                swalWithBootstrapButtons.fire({
                    title: `¿Seguro de crear esta categoria?`,
                    text: "Se creará",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        swalWithBootstrapButtons.fire(
                            ...
                            // location.href = `/${user.nameCompanie}/typeCompanie/${this.id_type}/create`
                            this.form.namecategori = null;
                            this.form.descripcategori = null;
