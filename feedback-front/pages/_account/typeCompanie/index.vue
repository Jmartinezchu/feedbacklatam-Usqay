    ...
    <div>
        ...
        <div class="d-flex justify-content-between" style="align-items:center ">
            <div class="col-9 flex">
                <nuxt-link :to="`typeCompanie/create`">
                    <div data-v-step="0"
            ...
            <div class="col-md-4 mt-4" v-for="typec in typesCompanies" :key="typec.id" v-if="typec.name != 'Usqay'">
                <div class="card" data-v-step="1">
                    <div class="card-header pb-0 px-3" style="text-align:center">
                        <v-icon style="font-size:50px">store</v-icon>
                    </div>
                        ...
                        <ul class="list-group flex_card_question">
                            <li class=" list-group-item border-0 mb-2 border-radius-lg w-100" style="margin: 0 3px">
                                ...
                                <div class="ms-auto text-center ">
                                    ...
                                    <nuxtLink data-v-step="2" :to="`typeCompanie/${typec.id}`"
                                        class="btn btn-link text-dark px-3 mb-0">
                                        <i class="fas fa-list-alt text-dark me-2" aria-hidden="true"></i>Categorias
                                    </nuxtLink>
...
export default {
    ...
    methods: {
        ...
        async deleteCupon(id) {
            const data = await this.$axios.$delete(`${Api}/type_companie/${id}`).catch(error => {
                console.log('Request canceled', error)
            })
            // console.log(data);
            this.verdata();
        ...
        getDelete(data) {
            ...
            swalWithBootstrapButtons.fire({
                title: `¿Seguro de Eliminar el tipo ${data.name}?`,
