        ...
        <div class="card_todo_question">
            ...
            <div class="animate__animated animate__fadeInRight">
                <div class="flex_center">
                    <div class="coment">
                        <h5>Tenemos Cupones disponibles para ti</h5>
                        <p>Ingresa tu número de celular</p>
                        <div v-if="stateAddCliente === 1" class="form-floating mb-3">
                            <strong>No tienes cuenta;</strong> Registrate ahora y participa <br> de los cupones que tenemos
                            para ti 🥳
                        </div>
                    </div>
                </div>
            ...
            <div class="btnPrimary">
                ...
                <a @click="getcreate()"><button>Continuar</button></a>
            </div>
    ...
    methods: {
        async getcreate() {
            if (this.stateAddCliente === 0) {
                ...
                if (this.form.nombre != "" && this.form.email != "" && this.form.celular != "" && this.form.nacimiento != "" && this.validEmail === 1) {
        ...
        // addComent() {
        //     location.href = `/forms/${this.route.idCompanie}/${this.route.idSucursal}/${this.route.idForm}/${this.id_cliente}`
