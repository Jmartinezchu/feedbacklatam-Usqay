...
//   var mainWhite = document.querySelector("main:not(.dark-version)");
//   var mainDark = main.classList.contains('dark-version');
...
//   if (main.classList.contains('g-sidenav-pinned')) {
//     main.classList.remove(className);
//   }
// });
...
// //   if (main.classList.contains('g-sidenav-pinned') && !e.target.classList.contains('sidenav-toggler-line')) {
// //     main.classList.remove(className);
// //   }
// // });
...
//       sidenav.classList.remove('bg-white');
//     } else {
//       if (!main.classList.contains('dark-version')) {
//         sidenav.classList.add('bg-white');
//       }
//     }
//   } else {
...
//   if (!el.getAttribute("checked")) {
//     main.classList.add('dark-version');
//     if (navbarBrandImg.includes('logo-ct-dark.png')) {
//       var navbarBrandImgNew = navbarBrandImg.replace("logo-ct-dark", "logo-ct");
//       navbarBrand.src = navbarBrandImgNew;
//     }
...
//     el.setAttribute("checked", "true");
//   } else {
//     main.classList.remove('dark-version');
